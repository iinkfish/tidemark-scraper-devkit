...
export async function run() {
   const urlpm10 = "https://www.lfu.bayern.de/luft/immissionsmessungen/messwerte/stationen/detail/706/132/";
   const urlno2 = "https://www.lfu.bayern.de/luft/immissionsmessungen/messwerte/stationen/detail/706/172/";
   const urlpm25 = "https://www.lfu.bayern.de/luft/immissionsmessungen/messwerte/stationen/detail/706/130/";
   const urlO3 = "https://www.lfu.bayern.de/luft/immissionsmessungen/messwerte/stationen/detail/706/180/";
   ...
   const pm25 = await parsePage(urlpm25);
   const O3 = await parsePage(urlO3);


  return {
    time: parseToISO(pm10.date),
    medium: "air",
    location: "Augsburg, Bourges-Platz",
    measurement: "environmental",
    scrapedAt: new Date().toISOString(),
    fields: {
      pm10: {value: pm10.value, unit: "µg/m³"},
      no2: {value: no2.value, unit: "µg/m³"},
      pm25: {value: pm25.value, unit: "µg/m³"},
      ozone: {value: O3.value, unit: "µg/m³"},
    },
  };
}
