...
export async function run() {
  const url = "https://www.hnd.bayern.de/grundwasser/iller_lech/lechhausen-645-8200";
  ...
  const valueRaw =firstRow.find("td").eq(2).text().trim();
  ...
  return {
    ...
    medium: "water",
    location: "Augsburg, Lechhausen",
    measurement: "environmental",
    scrapedAt: new Date().toISOString(),
    fields: {
      groundwaterlevel: {value: valueClean, unit: "m"},
    },
  };
}
